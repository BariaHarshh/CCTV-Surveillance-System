...
class TestRiskManagementOrchestrator(unittest.TestCase):
    ...
    def test_1_full_preset_initializes_all_four_features(self):
        ...
        preset_data = self._load_preset_data("risk_management_full.yaml")
    ...
    def test_2_lightweight_preset_initializes_only_selected_features(self):
        """Test 2: Lightweight preset initializes only crowd & restricted, while behavior and abandoned object are DISABLED."""
        preset_data = self._load_preset_data("risk_management_lightweight.yaml")
        orchestrator = RiskManagementOrchestrator(config_data=preset_data, device="cpu", imgsz=416)
    ...
    def test_3_behavior_preset_initializes_only_behavior_and_restricted(self):
        """Test 3: Behaviour preset initializes only behaviour and restricted area."""
        preset_data = self._load_preset_data("risk_management_behavior.yaml")
        orchestrator = RiskManagementOrchestrator(config_data=preset_data, device="cpu", imgsz=416)
    ...
    def test_4_disabled_features_zero_inference_overhead(self):
        ...
        full_data = self._load_preset_data("risk_management_full.yaml")
    ...
    def test_9_demo_preset_activates_accelerated_timers(self):
        """Test 9: Demo preset sets demo_mode=True and initializes shortened persistence timers."""
        preset_data = self._load_preset_data("risk_management_demo.yaml")
        orchestrator = RiskManagementOrchestrator(config_data=preset_data, device="cpu", imgsz=416)
